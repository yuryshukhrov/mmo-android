...
public class DuelRequestListeners extends ListenersAdapter<DuelRequestListener>
	...
	private final Function2<DuelRequestListener, String, String> onDuelIsFull = new Function2<DuelRequestListener, String, String>() {
		@Override
		public void call(DuelRequestListener listener, String owner, String name) {
			listener.onDuelIsFull(owner, name);
		}
	};
	...
	private final Function2<DuelRequestListener, String, String> onPlayerRemovedFromDuel = new Function2<DuelRequestListener, String, String>() {

		@Override
		public void call(DuelRequestListener listener, String owner, String name) {
			listener.onPlayerRemovedFromDuel(owner, name);
		}
	};
	...
	public void onDuelIsFull(String owner, String name) {
		callAllListeners(this.onDuelIsFull, owner, name);
	...
	public void onPlayerRemovedFromDuel(String owner, String name) {
		callAllListeners(this.onPlayerRemovedFromDuel, owner, name);
