...
import com.yuri.game.resource.parsers.FightAttackStateParser;
import com.yuri.game.resource.parsers.FightMessageParser;
import com.yuri.game.resource.parsers.FightRegistrationParser;
import com.yuri.game.resource.parsers.FightStartInitStatsParser;
...
public class ServerMessageHandler {
	...
	public void resolveCode() {
		...
		case ServerRespondCodes.CHARACTER_NOT_FOUND:
			// Вывести диалог что юзер не найден
			break;
		...
		case ServerRespondCodes.FIGHT_REGISTERED:
		case ServerRespondCodes.FIGHT_UNREGISTERED:	
			FightRegistrationParser.startParsing(app, message);
			break;
		case ServerRespondCodes.FIGHT_MESSAGE:
			FightMessageParser.startParsing(app, message);
			break;
		case ServerRespondCodes.ATTACK_STATE_MESSAGE:
			FightAttackStateParser.startParsing(app, message);
			break;
		case ServerRespondCodes.ENEMY_INIT_STATS_MESSAGE:
			FightStartInitStatsParser.startParsing(app, message);
			break;
