...
public final class Player extends Actor {
	...
	public Player(int strength, int agility, int luck, int toughness,
			int critical, int antiCritical, int dodge, int antiDodge,
			int headArmor, int chestArmor, int abdomenArmor, int legArmor,
			int level, int experience, int minDamage, int maxDamage,
			int currentHP, int maxHP, LocationType locationType,
			boolean hasActiveDuelRequest, boolean acceptedDuelRequest,
			State playerState, RaceType race, GenderType gender, String name,
			OnlineState state) {
	...
	public void setActiveDuelRequest(boolean hasActiveDuelRequest) {
		this.hasActiveDuelRequest = hasActiveDuelRequest;
	}

	public boolean hasAcceptedDuelRequest() {
