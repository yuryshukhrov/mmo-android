...
import com.yuri.game.model.actor.OnlineState;
...
import com.yuri.game.model.actor.Player.State;
...
public class PlayerStatsParser extends DefaultHandler {
	...
	public void endElement(String uri, String localName, String qName)
		...
		if (localName.equalsIgnoreCase("name")) {
			...
			player.setState(OnlineState.valueOf(buffer.toString()));
		}
		
		else if (localName.equalsIgnoreCase("state")) {
			player.setPlayerState(State.valueOf(buffer.toString()));
		}
