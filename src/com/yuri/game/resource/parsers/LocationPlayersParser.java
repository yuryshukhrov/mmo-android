...
public class LocationPlayersParser extends DefaultHandler {
	...
	public void endElement(String uri, String localName, String qName)
		...
		if (localName.equalsIgnoreCase("location")) {
			Log.e(TAG, "Location: " + buffer.toString());
			locationType = LocationType.valueOf(buffer.toString());
		}
		...
		if (localName.equalsIgnoreCase("character")) {
			...
			Log.e(TAG, "Name: " + name);
			player.setName(name);
			player.setLocationType(locationType);
	...
	public void startElement(String uri, String localName, String qName,
		...
		if (localName.equalsIgnoreCase("character")) {
			...
			if (v2 != null) {
				gender = GenderType.valueOf(v2.toUpperCase());
